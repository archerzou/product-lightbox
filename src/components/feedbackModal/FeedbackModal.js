  ...
  onSubmitFeedback = () => {
    ...
    render = () => (
        <Modal trigger={this.props.trigger} onClose={this.onClose} closeIcon>
            <Modal.Header style={styles.title}>Have feedback, questions, comments, or want to reach out to us? Send us a message here, or email us at kevin.zou@honeywell.com.</Modal.Header>
            <Modal.Content>
                <Modal.Description>
